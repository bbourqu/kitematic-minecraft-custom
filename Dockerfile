...
MAINTAINER Brett Bourquin <brett@bourqu.in>
...
CMD echo eula=true > /data/eula.txt && echo gamemode=1 > /data/server.properties && java -Xms1G -Xmx1G -jar /minecraft_server.1.10.2.jar nogui 
